...
public class GraphQLAnnualWorkingHoursFetcher {
    ...
    public static DataFetcher<List<AnnualWorkingHours>> annualWorkingHoursByCountryAbbrev = environment -> AnnualWorkingHours.byCountryAbbrev(environment.getArgument("countryAbbrev"));
    public static DataFetcher<List<AnnualWorkingHours>> annualWorkingHoursByCountryName = environment -> AnnualWorkingHours.byCountryName(environment.getArgument("countryName"));
